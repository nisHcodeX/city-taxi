...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> findByCustomerIdAndStatusOrderByCreatedAt(Long customerId, EBookingStatus status);
    List<Booking> findByDriverId(Long driverId);
    List<Booking> findByDriverIdAndStatusOrderByCreatedAt(Long driverId, EBookingStatus status);
