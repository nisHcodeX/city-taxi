...
public interface DriverRepository extends JpaRepository<Driver, Long> {
    ...
    @Query("SELECT new com.citytaxi.city_taxi.models.dtos.driver.response.DriverGetResponse(d.id, d.name, d.email, d.phoneNumber, d.driverLicense, d.latitude, d.longitude, d.createdAt, d.updatedAt) FROM Driver d")
